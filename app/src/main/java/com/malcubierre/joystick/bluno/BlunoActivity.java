...
/**
 * Created by malcubierre on 1/2/17.
 */
...
public abstract  class BlunoActivity extends AppCompatActivity {
...
//	byte[] mBaudrateBuffer={0x32,0x00,(byte) (mBaudrate & 0xFF),(byte) ((mBaudrate>>8) & 0xFF),(byte) ((mBaudrate>>16) & 0xFF),0x00};;
    ...
    private final static String TAG = BlunoActivity.class.getSimpleName();
